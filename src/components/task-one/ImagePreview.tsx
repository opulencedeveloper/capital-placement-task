...
const ImagePreview: React.FC<ImagePreviewProps> = ({ imageFile, deleteImage }) => {
    return (
        <div className="flex flex-col overflow-hidden rounded-[20px] items-center shadow-custom-shadow max-w-[560px] mt-20 ml-12">
            <div className="w-full h-[300px] border rounded-[5px]">
                <img src={URL.createObjectURL(imageFile)} className="h-full w-full" alt="Preview" />
            </div>
