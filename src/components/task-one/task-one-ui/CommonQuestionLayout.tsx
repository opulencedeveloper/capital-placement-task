...
const CommonQuestionLayout: React.FC<CommonQuestionLayoutProps> = ({ layoutStyle, onChange }) => {
                    ...
                    {Array.from({ length: inputCount }).map((_, index) => (
                        <div key={index} className="flex items-center">
                            ...
                            <input
                                ...
                                className="text-[16px] pl-5 w-full rounded-[5px] h-[68px] outline-none border border-secondary-3"
                            />
                        </div>
                    ))}
                </div>
